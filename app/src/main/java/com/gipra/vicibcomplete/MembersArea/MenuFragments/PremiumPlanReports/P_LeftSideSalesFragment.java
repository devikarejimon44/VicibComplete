...
public class P_LeftSideSalesFragment extends Fragment {
    ...
    public P_LeftSideSalesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_p__left_side_sales, container, false);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Left Side Sales");

        m_shimmer_pr_leftside_sales=view.findViewById(R.id.m_shimmer_pr_leftside_sales);
        nodata_pr_leftside_sales=view.findViewById(R.id.nodata_pr_leftside_sales);

        Recycler_premium_left_side_sales=view.findViewById(R.id.Recycler_premium_left_side_sales);
        premium_left_side_sales_fromdate=view.findViewById(R.id.premium_left_side_sales_fromdate);
        premium_left_side_sales_todate=view.findViewById(R.id.premium_left_side_sales_todate);
        ...
        premium_left_side_sales_search=view.findViewById(R.id.premium_left_side_sales_search);
