...
public class St_LeftSideSalesFragment extends Fragment {
    ...
    ImageView nodata_st_leftside_sales;

    public St_LeftSideSalesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view= inflater.inflate(R.layout.fragment_st__left_side_sales, container, false);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Left Side Sales");

        m_shimmer_st_leftside_sales=view.findViewById(R.id.m_shimmer_st_leftside_sales);
        recycler_standard_left_side_sales=view.findViewById(R.id.recycler_standard_left_side_sales);
        standard_left_side_sales_fromdate=view.findViewById(R.id.standard_left_side_sales_fromdate);
        standard_left_side_sales_todate=view.findViewById(R.id.standard_left_side_sales_todate);
        ...
        search_standard_left_side_sales=view.findViewById(R.id.search_standard_left_side_sales);
        ...
        nodata_st_leftside_sales=view.findViewById(R.id.nodata_st_leftside_sales);
        ...
        usercall.enqueue(new Callback<ResponseStandardLeftSideSales>() {
            ...
            public void onResponse(Call<ResponseStandardLeftSideSales> call, Response<ResponseStandardLeftSideSales> response) {
                ...
                if (response.body().getStatus().equals("1")){
                    ...
                    nodata_st_leftside_sales.setVisibility(View.GONE);
                    ...
                    nodata_st_leftside_sales.setVisibility(View.VISIBLE);
